...
|Use the {registry} native Data Contracts feature for contract metadata and rulesets. See xref:getting-started/assembly-data-contracts.adoc[Data Contracts].
|===
