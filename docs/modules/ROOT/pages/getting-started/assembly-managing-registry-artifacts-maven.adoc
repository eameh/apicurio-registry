...
To update draft content or promote a draft created in this way, artifact version mutability must be enabled on the server. For more details, see xref:getting-started/assembly-deploying-registry-operator.adoc#enabling-version-mutability_{context}[Enabling artifact version mutability].
